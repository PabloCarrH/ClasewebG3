...
let arrayPalabras =["BARRANQUILLA", "CARTAGENA", "VALLENATO", "WAYUU", "GUANDOCA", "BUTIFARRA"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "conocida como la puerta de oro",
    "conocida como la ciudad amurallada",
    "genero musical representativo de valledupar",
    "indigenas de la guajira",
    "expresion que se utiliza para refierise a carcel o prision",
    "embutido tradicional de la region del atlantico"
]
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["BARRANQUILLA", "CARTAGENA", "VALLENATO", "WAYUU", "GUANDOCA", "BUTIFARRA"];
        ayudas = [
            "conocida como la puerta de oro",
            "conocida como la ciudad amurallada",
            "genero musical representativo de valledupar",
